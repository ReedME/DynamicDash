					...
					<div>
						<div className="top-head d-flex justify-content-between align-items-center">
							<h4 className="mb-0 text-capitalize w-75 d-flex align-items-center">
								...
								<span>Fwd: {currentEmail.email_subject}</span>
							</h4>
						...
						<div className="user-detail d-flex justify-content-between border-0">
							<div className="media w-80">
								{currentEmail.from.avatar !== '' ?
									<img src={currentEmail.from.avatar} alt="user profile" className="rounded mr-20" width="50" height="50" />
									: <Avatar className="mr-20">{currentEmail.from.name.charAt(0)}</Avatar>
								}
								<div className="media-body">
									<h5>{currentEmail.from.name}</h5>
									<p className="mb-0">From <span className="text-muted font-sm">&lt;{currentEmail.from.email}&gt;</span></p>
									<p className="mb-0">To: <span className="text-muted font-sm">Me</span></p>
								</div>
							</div>
							<span className="align-items-center d-flex small text-muted w-20 text-right">{currentEmail.received_time}</span>
						</div>
						<div className="mail-detail pl-lg-70 pt-0">
							<div className="mb-20 pl-lg-15">
								<p>{currentEmail.email_content}</p>
							</div>
							<p className="mb-0 pl-lg-15">Regards,</p>
							<p className="mb-0 pl-lg-15">Mike Mayers</p>
						</div>
